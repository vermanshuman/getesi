...
import it.nexera.ris.common.utils.APICall;
...
public class FatturaAPI {
    ...
    public String getDataForXML(Invoice invoice) throws SAXException, ParserConfigurationException, IOException, TransformerException, HibernateException, InstantiationException, IllegalAccessException, PersistenceBeanException {
    ...
    public Boolean callFatturaAPI(String xmlSource) throws ClientProtocolException, IOException, JAXBException {
        ...
        if (response.getStatusLine().getStatusCode() != 200) {
            System.out.println("some error occured :: "+response.getStatusLine().getStatusCode());
            return false;
        }
        String responseString = EntityUtils.toString(response.getEntity(), "UTF-8");
        System.out.println("Response received :: responseString :: " + responseString);
        ...
        System.out.println("fatturaAPIResponse returncode :: "+fatturaAPIResponse.getReturnCode());
        System.out.println("fatturaAPIResponse description :: "+fatturaAPIResponse.getDescription());
        if(fatturaAPIResponse.getReturnCode() == 0) {
            System.out.println("fatturaAPIResponse doc Id :: "+fatturaAPIResponse.getDocId());
            System.out.println("fatturaAPIResponse doc number :: "+fatturaAPIResponse.getDocNumber());
            return true;
        }
        return false;
    }
