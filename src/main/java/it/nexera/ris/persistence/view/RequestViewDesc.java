...
@Immutable
@Table(name = "request_subject_view_desc")
@View(sql = RequestViewDesc.QUERY)
public class RequestViewDesc extends IndexedView {
    ...
    public static final String CREATE_PART = "CREATE OR REPLACE VIEW request_subject_view_desc ";
    ...
    public static final String SELECT_PART = "AS SELECT GROUP_CONCAT(rqsts.nameR SEPARATOR ' / ') as name, "
            ...
            + "and (section_c_type = 'Contro' or section_c_type is null)"
            + GROUP_BY_PART
            + ") as rqsts group by rqsts.ID order by CREATE_DATE desc";
