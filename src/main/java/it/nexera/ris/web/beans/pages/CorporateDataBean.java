...
public class CorporateDataBean extends EntityEditPageBean<ApplicationSettingsValue> implements Serializable {
	...
	public void onLoad() throws NumberFormatException, HibernateException, PersistenceBeanException,
		...
		setTelephone(ApplicationSettingsHolder.getInstance().getByKey(ApplicationSettingsKeys.TELEPHONE).getValue());
		setFax(ApplicationSettingsHolder.getInstance().getByKey(ApplicationSettingsKeys.FAX).getValue());
	...
	public void onSave() throws HibernateException, PersistenceBeanException, NumberFormatException, IOException,
		...
		ApplicationSettingsHolder.getInstance().applyNewValue(ApplicationSettingsKeys.TELEPHONE, getTelephone());
		ApplicationSettingsHolder.getInstance().applyNewValue(ApplicationSettingsKeys.FAX, getFax());
