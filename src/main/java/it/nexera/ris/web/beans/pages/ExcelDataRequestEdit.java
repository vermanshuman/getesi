...
@ManagedBean
@ViewScoped
public class ExcelDataRequestEdit extends BaseEntityPageBean {
    ...
    protected void onConstruct() {
        ...
        List<Long> selectedRequestIds = new ArrayList<>();
...
//            }
    ...
    private void addColumnValues(Request request,
        ...
        } else if (!ValidationHelper.isNullOrEmpty(SessionHelper.get("templateIdForExcelData"))) {
        	request.setSelectedTemplateId((Long) SessionHelper.get("templateIdForExcelData"));
        }
