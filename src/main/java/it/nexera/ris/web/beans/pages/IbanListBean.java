...
@ViewScoped
public class IbanListBean extends EntityLazyInListEditPageBean<Iban>
	...
	public void onLoad() throws NumberFormatException, HibernateException, PersistenceBeanException,
		...
		this.loadList(Iban.class, new Criterion[] { },
				new Order[]
	...
	protected void setEditedValues() {
        ...
        this.getEditedEntity().setBankName(
        		this.getEntity().getBankName());
        this.getEditedEntity().setAddress(
        		this.getEntity().getAddress());
	}
