...
public class RelationshipTypeListBean extends
    ...
    private TipologieDiritti entity;
    ...
    public void onLoad() throws NumberFormatException, HibernateException,
        ...
        setEntity(new TipologieDiritti());
    }
    ...
    public void editEntity() throws HibernateException, InstantiationException, IllegalAccessException, PersistenceBeanException {
        if (this.getCanEdit()) {
            ...
            RequestContext.getCurrentInstance().update("addRelationshipTypeDialog");
            executeJS("PF('addRelationshipTypeDialogWV').show();");
        }
    }
    ...
    public void save() throws HibernateException, PersistenceBeanException, NumberFormatException, IOException,
        ...
        saveEntity();
        this.resetFields();
        executeJS("PF('addRelationshipTypeDialogWV').hide()");
