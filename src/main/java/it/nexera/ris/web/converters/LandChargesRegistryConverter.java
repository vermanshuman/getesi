...
@FacesConverter(value = "landChargesRegistryConverter")
public class LandChargesRegistryConverter implements Converter {
    public transient final Log log = LogFactory
            .getLog(LandChargesRegistryConverter.class);

    @Override
    public Object getAsObject(FacesContext context, UIComponent component,
                              String value) {
        try {
            return DaoManager.get(LandChargesRegistry.class, new Criterion[]
