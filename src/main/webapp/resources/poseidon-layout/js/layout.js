...
PrimeFaces.widget.Poseidon = PrimeFaces.widget.BaseWidget.extend({
    ...
    init: function(cfg) {
        this._super(cfg);
        this.wrapper = $(document.body).children('#rootPanel').children('.layout-wrapper');
        this.topbar = $(document.body).children('#rootPanel').children('.layout-wrapper').children('#header_form_panel').children('.topbar');
        this.menu = this.jq;
